...
const SelectTrigger = ({ children, className, ...props }: SelectPrimitive.SelectTriggerProps) => {
  return (
...
const SelectItem = ({ children, className, ...props }: SelectPrimitive.SelectItemProps) => (
